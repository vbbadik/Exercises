...
//        tableView.tableHeaderView = segmented
    ...
    // Отобразить/скрыть выполненные упражнения
...
//        showHideImage = (sets?[section].isVisible)! ? hideImage : showImage
//        if sets?[indexPathForDate.section].isVisible == true {
//            sets?[indexPathForDate.section].isVisible = false
//            let section = IndexSet.init(integer: indexPathForDate.section)
//            tableView.reloadSections(section, with: .fade)
//        } else {
//            sets?[indexPathForDate.section].isVisible = true
//            let section = IndexSet(integer: indexSetSection)
